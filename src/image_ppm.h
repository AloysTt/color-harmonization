...
void ecrire_image_pgm_2o(char nom_image[], unsigned short *pt_image, int nb_lignes, int nb_colonnes)
{
	FILE *f_image;
	int taille_image = nb_colonnes * nb_lignes;
	...
	{
		fprintf(f_image,"P5\r") ;                               /*ecriture entete*/
		fprintf(f_image,"%d %d\r65535\r", nb_colonnes, nb_lignes) ;

		if( (fwrite(pt_image, sizeof(unsigned short), taille_image, f_image))
			!= (size_t) taille_image)
		{
